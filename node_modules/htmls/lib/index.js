var lsc, elems, voids, fs, base, ref$, filter, each, map, lines, unlines, unique, el, xel, indent, parseNodes, commonCompile, compile, compileHtml, compileXml;
lsc = require('LiveScript');
elems = require('./elements');
voids = require('./void');
fs = require('fs');
base = fs.readFileSync(__dirname + '/_base.ls', 'utf8');
